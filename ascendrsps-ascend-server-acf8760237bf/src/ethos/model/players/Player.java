...
public class Player extends Entity {
	...
	public void destruct() {
		...
		if(getMode().isUltimateIronman()) {
			com.everythingrs.hiscores.Hiscores.update("zlfhyknitg3ygmwes2bc07ldi4gtajdhn7ln3tjybiu76jkbj4i7m3pavp7jjgek1p2twlcvxi529",  "Ultimate Iron Man", this.playerName, this.playerRank, this.playerXP, debugMessage);
		}
