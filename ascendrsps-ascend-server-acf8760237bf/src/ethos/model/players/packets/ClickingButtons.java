...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case 113243:
			...
			break;
		case 185154: // yt
			c.getPA().sendFrame126("www.ascend-ps.com/", 12000);
			// https://www.youtube.com/user/DopeRsps/videos
			break;
		case 185155: // Discord
			c.getPA().sendFrame126("http://ascendosrs.everythingrs.com/services/vote", 12000);
			// https://www.youtube.com/user/DopeRsps/videos
			break;
		case 185156: // Store
			c.getPA().sendFrame126("http://ascendosrs.everythingrs.com/services/store", 12000);
			...
			case 185157: // Store
				...
				break;
			case 185158: // Store
				c.getPA().sendFrame126("https://ascend-ps.com/forums/index.php?/forum/9-guides/", 12000);
				//c.getPA().sendFrame126("https://OSPSrs.com/store", 12000);
				// https://www.youtube.com/user/DopeRsps/videos
				break;
			case 185142:
